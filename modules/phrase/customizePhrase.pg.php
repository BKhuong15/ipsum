<?php
function customizePhrase()
{
$template = new HTMLTemplate();
$template->setTitle('Customize Phrase Template');

// Start building the output
$output = menu();
$output .= htmlWrap('h1', 'Customize Phrase Template');

// Adding paragraphs with "Copy" buttons
$output .= htmlWrap('p', ipsum(100)) . htmlSolo('input', array('type' => 'button', 'value' => 'Copy', 'class' => array('copy')));
$output .= htmlWrap('p', ipsum(500)) . htmlSolo('input', array('type' => 'button', 'value' => 'Copy', 'class' => array('copy')));
$output .= htmlWrap('p', ipsum(1000)) . htmlSolo('input', array('type' => 'button', 'value' => 'Copy', 'class' => array('copy')));

// Assuming getUrlID() and getPhrasePager() are defined functions
...
{
$row = array();
$attr = array('query' => array('id' => $name_category['id']));
...
$output .= $table->__toString();  // Append the table to output
...
$form->setValues($name);
$title = 'Edit Phrase ' . htmlWrap('em', formatName($name));
}
$form->setTitle($title);
